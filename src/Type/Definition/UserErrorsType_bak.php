 ...
 */
final class UserErrorsType_bak extends ObjectType
{
    ...
    {
        $createSubErrors = UserErrorsType_bak::needSuberrors($config, $isParentList);
    ...
    public static function create(array $config, array $path, bool $isParentList = false, string $name = ''): ?self
    {
        ...
        $userErrorType = new UserErrorsType_bak($config, $path, $isParentList);
